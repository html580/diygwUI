<template>
	<view class="container">
		...
		<view class="flex diygw-col-24 justify-between">
			...
			<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid2.png)"> </view>
			<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid3.png)"> </view>
			<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid4.png)"> </view>
			<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid5.png)"> </view>
			<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid6.png)"> </view>
		</view>
