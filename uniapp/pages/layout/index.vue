<template>
	<view class="container">
		<view style="" class="diygw-title flex diygw-col-24">
		...
		<view class="flex flex-wrap diygw-col-24 items-start flex1-clz">
			<view class="flex diygw-col-4">
				<view class="diygw-avatar white radius diygw-shadow" style="background-image: url(/static/grid1.png)"> </view>
			</view>
			<view class="diygw-col-19" v-html="text1"></view>
		</view>
		<view class="flex flex-wrap diygw-col-24 items-center flex6-clz">
			<view class="flex diygw-col-4">
				<view class="diygw-avatar gradual-pink radius">
					<text class="diy-icon-home"></text>
				</view>
			</view>
			<view class="diygw-col-19" v-html="text2"></view>
		</view>
		<view class="flex flex-wrap diygw-col-24 items-end flex7-clz">
			<view class="flex diygw-col-4">
				<view class="diygw-avatar gradual-red radius">
					<view> 好 </view>
				</view>
			</view>
			<view class="diygw-col-19" v-html="text3"></view>
		</view>
		<view class="flex flex-wrap diygw-col-24 flex-direction-row-reverse items-center flex9-clz">
			<view class="flex diygw-col-4">
				<view class="diygw-avatar radius bg-none" style="background-image: url(/static/grid1.png)"> </view>
			</view>
			<view class="diygw-col-19" v-html="text5"></view>
		</view>
