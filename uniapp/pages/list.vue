	...
	<view class="container">
		...
		<view class="flex diygw-col-24 list9-clz">
			<view class="diygw-list not-remark">
				<view @tap="navigateTo" data-type="page" data-url="/pages/zsff/zsff" style="" class="diygw-item col-50 flex-direction-column solid-bottom list9-item-clz">
					<view class="diygw-avatar radius">
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/zsff/zsfflb" style="" class="diygw-item col-50 flex-direction-column solid-bottom list9-item-clz">
					<view class="diygw-avatar radius">
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/zsff/zsffsq" style="" class="diygw-item col-50 flex-direction-column solid-bottom list9-item-clz">
					<view class="diygw-avatar radius">
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/zsff/zsffgl" style="" class="diygw-item col-50 flex-direction-column solid-bottom list9-item-clz">
					<view class="diygw-avatar radius">
		...
		<view class="flex diygw-col-24">
			<view class="diygw-list">
				<view @tap="navigateTo" data-type="page" data-url="/pages/layout" style="" class="diygw-item col-50 row arrow solid-bottom diygw-card diygw-shadow list2-item-clz bg-gradual-orange">
					<view class="diygw-avatar diy-icon-circle"> </view>
					<view class="content">
						<view class="title"> 布局 </view>
						<view class="text-sm remark"> Layout </view>
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/avatar" style="" class="diygw-item col-50 row arrow solid-bottom diygw-card diygw-shadow list2-item-clz bg-gradual-blue">
					<view class="diygw-avatar diy-icon-emoji"> </view>
					<view class="content">
						<view class="title"> 图标 </view>
						<view class="text-sm remark"> Icon </view>
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/button" style="" class="diygw-item col-50 row arrow solid-bottom diygw-card diygw-shadow list2-item-clz bg-gradual-pink">
					<view class="diygw-avatar diy-icon-btn"> </view>
					<view class="content">
						<view class="title"> 按钮 </view>
						<view class="text-sm remark"> Button </view>
		...
		<view class="flex diygw-col-24">
			<view class="diygw-list">
				<view @tap="navigateTo" data-type="page" data-url="/pages/layout" style="" class="diygw-item col-33 flex-direction-column solid-bottom diygw-card diygw-shadow list1-item-clz bg-green">
					<view class="diygw-avatar diy-icon-circle"> </view>
					<view class="content">
						<view class="title"> 布局 </view>
						<view class="text-sm remark"> Layout </view>
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/avatar" style="" class="diygw-item col-33 flex-direction-column solid-bottom diygw-card diygw-shadow list1-item-clz bg-orange">
					<view class="diygw-avatar diy-icon-emoji"> </view>
					<view class="content">
						<view class="title"> 图标 </view>
						<view class="text-sm remark"> Icon </view>
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/button" style="" class="diygw-item col-33 flex-direction-column solid-bottom diygw-card diygw-shadow list1-item-clz bg-olive">
					<view class="diygw-avatar diy-icon-btn"> </view>
					<view class="content">
						<view class="title"> 按钮 </view>
						<view class="text-sm remark"> Button </view>
				...
				<view @tap="navigateTo" data-type="page" data-url="/pages/tag" style="" class="diygw-item col-33 flex-direction-column solid-bottom diygw-card diygw-shadow list1-item-clz bg-cyan">
