	...
	<view class="container">
		<view class="flex diygw-col-24 flex-direction-column">
			...
			<view class="flex justify-end">
				<button @tap="changeSteps('prev')" class="diygw-btn line-green radius-xs flex-sub margin-xs">上一步</button>
				<button @tap="changeSteps('next')" class="diygw-btn green radius-xs flex-sub margin-xs">下一步</button>
			</view>
		</view>
		<view style="" class="diygw-title flex diygw-col-24 gradual-purple title-clz">
		...
		<view class="flex diygw-col-24 flex-direction-column-reverse">
			...
			<view class="flex justify-end">
				<button @tap="changeSteps1('prev')" class="diygw-btn line-green radius-xs flex-sub margin-xs">上一步</button>
				<button @tap="changeSteps1('next')" class="diygw-btn green radius-xs flex-sub margin-xs">下一步</button>
			</view>
		</view>
		<view style="" class="diygw-title flex diygw-col-24 cyan title3-clz">
			<view class="title font-normal"> <text class="diy-icon-home"></text> 箭头步骤 </view>
		</view>
		<view class="flex diygw-col-24 flex-direction-column">
			<view class="diygw-steps steps-arrow">
				<view class="diygw-step-item" :class="[index > steps4Index ? '' : item.textClazz]" v-for="(item, index) in steps4Datas" :key="index">
					<text :class="[index > steps4Index ? item.icon : item.successIcon]"></text>
					<text>
						{{ item.text }}
					</text>
				</view>
			...
			<view class="flex justify-end">
				<button @tap="changeSteps4('prev')" class="diygw-btn line-green radius-xs flex-sub margin-xs">上一步</button>
				<button @tap="changeSteps4('next')" class="diygw-btn green radius-xs flex-sub margin-xs">下一步</button>
			</view>
		</view>
		<view style="" class="diygw-title flex diygw-col-24 purple title1-clz">
			<view class="title font-normal"> <text class="diy-icon-home"></text> 数字步骤 </view>
		</view>
		<view class="flex diygw-col-24 flex-direction-column">
			<view class="diygw-steps steps-numbers">
				<view class="diygw-step-item" :class="[index > steps2Index ? '' : item.textClazz]" v-for="(item, index) in steps2Datas" :key="index">
			...
			<view class="flex justify-end">
				<button @tap="changeSteps2('prev')" class="diygw-btn line-green radius-xs flex-sub margin-xs">上一步</button>
				<button @tap="changeSteps2('next')" class="diygw-btn green radius-xs flex-sub margin-xs">下一步</button>
			</view>
		</view>
		<view style="" class="diygw-title flex diygw-col-24 gradual-orange title2-clz">
			<view class="title font-normal"> <text class="diy-icon-home"></text> 水平滚动步骤 </view>
		</view>
		<view class="flex diygw-col-24 flex-direction-column">
			<scroll-view scroll-x :scroll-into-view="'scroll-' + steps3Index" scroll-with-animation class="diygw-steps">
				<view :id="'scroll-' + index" class="diygw-step-item" :class="[index > steps3Index ? '' : item.textClazz]" v-for="(item, index) in steps3Datas" :key="index">
					<text :class="[index > steps3Index ? item.icon : item.successIcon]"></text>
					<text>
						{{ item.text }}
					</text>
				</view>
			...
			<view class="flex justify-end">
				<button @tap="changeSteps3('prev')" class="diygw-btn line-green radius-xs flex-sub margin-xs">上一步</button>
				<button @tap="changeSteps3('next')" class="diygw-btn green radius-xs flex-sub margin-xs">下一步</button>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			changeSteps4(stepType) {
				if (stepType == 'prev') {
					if (this.steps4Index > -1) {
						this.steps4Index = this.steps4Index - 1;
					} else {
						this.showToast('已经是初始位置', 'none');
					}
				} else {
					if (this.steps4Index < this.steps4Datas.length - 1) {
						this.steps4Index = this.steps4Index + 1;
					} else {
						this.showToast('已经是最后一个', 'none');
					}
