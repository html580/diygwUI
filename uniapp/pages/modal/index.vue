<template>
	<view class="container">
							...
							<view class="diygw-grid col-3">
								<view class="diygw-grid-item">
									<view style="" class="diygw-grid-inner">
										<view style="background-image: url(/static/dea614e9f1ff.jpg)" class="diygw-grid-icon diygw-avatar radius"> </view>
		...
		<view class="flex diygw-col-24">
			<button style="" @tap="navigateTo" data-type="openmodal" data-id="modal2" class="diygw-btn green flex1 margin-xs">左边抽屉</button>
		</view>
						...
						<view class="flex diygw-col-24">
							<view class="diygw-list">
								<view style="" class="diygw-item col-100 row solid-bottom">
									<view style="background-image: url(/static/dea614e9f1ff.jpg)" class="diygw-avatar radius"> </view>
									<view class="content">
		...
		<view class="flex diygw-col-24">
			<button style="" @tap="navigateTo" data-type="openmodal" data-id="modal3" class="diygw-btn green flex1 margin-xs">右边抽屉</button>
		</view>
		<view class="flex diygw-col-24">
			<button style="" @tap="navigateTo" data-type="openmodal" data-id="modal1" class="diygw-btn green flex1 margin-xs">底部抽屉</button>
		</view>
