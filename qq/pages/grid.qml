		...
		<view class="diygw-grid col-3">
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-pullright"> </view>
					<view class="diygw-grid-title"> 菜单一 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-skin"> </view>
					<view class="diygw-grid-title"> 菜单二 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-addressbook"> </view>
					<view class="diygw-grid-title"> 菜单三 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-subscription"> </view>
					<view class="diygw-grid-title"> 菜单四 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-upstage"> </view>
					<view class="diygw-grid-title"> 菜单五 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid5-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius grid5-icon-clz diygwui diy-icon-ticket"> </view>
		...
		<view class="diygw-grid col-4">
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid6-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius diygwui diy-icon-pullright"> </view>
					<view class="diygw-grid-title"> 菜单一 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid6-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius diygwui diy-icon-skin"> </view>
					<view class="diygw-grid-title"> 菜单二 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid6-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius diygwui diy-icon-addressbook"> </view>
					<view class="diygw-grid-title"> 菜单三 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid6-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius diygwui diy-icon-subscription"> </view>
					<view class="diygw-grid-title"> 菜单四 </view>
				</view>
			</view>
		</view>
		...
		<view class="diygw-grid col-3">
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-pullright"> </view>
					<view class="diygw-grid-title"> 菜单一 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-skin"> </view>
					<view class="diygw-grid-title"> 菜单二 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-addressbook"> </view>
					<view class="diygw-grid-title"> 菜单三 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-subscription"> </view>
					<view class="diygw-grid-title"> 菜单四 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-upstage"> </view>
					<view class="diygw-grid-title"> 菜单五 </view>
				</view>
			</view>
			<view class="diygw-grid-item">
				<view class="diygw-grid-inner grid4-item-clz">
					<view class="diygw-grid-icon diygw-avatar radius-xs grid4-icon-clz diygwui diy-icon-ticket"> </view>
					<view class="diygw-grid-title"> 菜单六 </view>
				</view>
			</view>
		</view>
