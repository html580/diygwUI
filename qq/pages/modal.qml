<view class="container">
	<view class="flex diygw-col-24">
		<button catchtap="navigateTo" data-type="openmodal" data-id="modal" class="diygw-btn green flex1 margin-xs">打开模态框</button>
	</view>
	<view class="diygw-modal basic {{modal}}" style="z-index: 1000">
		<view class="diygw-dialog basis-lg">
			...
			<view class="flex justify-end">
				<button data-type="closemodal" catchtap="navigateTo" data-id="modal" class="diygw-btn green radius flex1 margin-xs">关闭</button>
			</view>
		</view>
	</view>
	<view class="flex diygw-col-24">
		<button catchtap="navigateTo" data-type="openmodal" data-id="modal2" class="diygw-btn green flex1 margin-xs">左边抽屉</button>
	</view>
	<view class="diygw-modal bottom-modal {{modal1}}" style="z-index: 1000">
		<view class="diygw-dialog">
			<view class="justify-end diygw-bar">
				<view class="content"> 底部抽屉 </view>
				<view class="action" data-type="closemodal" data-id="modal1" catchtap="navigateTo">
					<i class="diygwui diy-icon-close"></i>
				</view>
			</view>
			<view>
			...
			<view class="flex justify-end">
				<button data-type="closemodal" catchtap="navigateTo" data-id="modal1" class="diygw-btn green flex1 margin-xs">关闭</button>
			</view>
		</view>
	</view>
	<view class="diygw-modal drawer-left-modal {{modal2}}" style="z-index: 1000">
		<view class="diygw-dialog basis-lg">
			<view class="justify-end diygw-bar">
				<view class="content"> 左边抽屉 </view>
				<view class="action" data-type="closemodal" data-id="modal2" catchtap="navigateTo">
					<i class="diygwui diy-icon-close"></i>
				</view>
			</view>
			<view>
			...
			<view class="flex justify-end">
				<button data-type="closemodal" catchtap="navigateTo" data-id="modal2" class="diygw-btn green flex1 margin-xs">关闭</button>
			</view>
		</view>
	</view>
	<view class="diygw-modal drawer-right-modal {{modal3}}" style="z-index: 1000">
		<view class="diygw-dialog basis-lg">
			<view class="justify-end diygw-bar">
				<view class="content"> 右边抽屉 </view>
				<view class="action" data-type="closemodal" data-id="modal3" catchtap="navigateTo">
					<i class="diygwui diy-icon-close"></i>
				</view>
			</view>
			<view>
			...
			<view class="flex justify-end">
				<button data-type="closemodal" catchtap="navigateTo" data-id="modal3" class="diygw-btn green flex1 margin-xs">关闭</button>
			</view>
		</view>
	</view>
	<view class="flex diygw-col-24">
		<button catchtap="navigateTo" data-type="openmodal" data-id="modal3" class="diygw-btn green flex1 margin-xs">右边抽屉</button>
	</view>
	<view class="flex diygw-col-24">
		<button catchtap="navigateTo" data-type="openmodal" data-id="modal1" class="diygw-btn green flex1 margin-xs">底部抽屉</button>
	</view>
