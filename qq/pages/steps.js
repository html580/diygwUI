...
Page({
	data: {
		stepsDatas: [
			{ text: `开始`, icon: 'diygwui diy-icon-title', successIcon: 'diygwui diy-icon-usefullfill', textClazz: 'text-green' },
			{ text: `等待`, icon: 'diygwui diy-icon-title', successIcon: 'diygwui diy-icon-emoji', textClazz: 'text-green' },
			{ text: `错误`, icon: 'diygwui diy-icon-title', successIcon: 'diygwui diy-icon-close', textClazz: 'text-green' },
			{ text: `完成`, icon: 'diygwui diy-icon-title', successIcon: 'diygwui diy-icon-check', textClazz: 'text-green' }
		],
		stepsIndex: 0,
		steps1Datas: [
			{ text: `开始`, icon: 'diygwui diy-icon-title', successIcon: 'diygwui diy-icon-usefullfill', textClazz: 'text-green' },
		...
		steps1Index: 0,
		steps3Datas: [
			{ text: `开始`, icon: '', successIcon: 'diygwui diy-icon-usefullfill', textClazz: 'text-green' },
			{ text: `等待`, icon: '', successIcon: 'diygwui diy-icon-emoji', textClazz: 'text-green' },
			{ text: `错误`, icon: '', successIcon: 'diygwui diy-icon-close', textClazz: 'text-green' },
			{ text: `完成`, icon: '', successIcon: 'diygwui diy-icon-check', textClazz: 'text-green' }
		],
		steps3Index: 0,
		steps2Datas: [
			{ text: `开始`, icon: '', successIcon: 'diygwui diy-icon-usefullfill', textClazz: 'text-green' },
