<view class="container">
	<diy-navbar bgColor="gradual-green" isBack="{{true}}">
		...
		<view slot="content"> 知识付费个人中心 </view>
	</diy-navbar>
			...
			<view class="diygw-grid col-4">
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid4-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid4-icon-clz diygwui diy-icon-creative"> </view>
						<view class="diygw-grid-title"> 创作首页 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid4-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid4-icon-clz diygwui diy-icon-rank"> </view>
						<view class="diygw-grid-title"> 数据助手 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid4-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid4-icon-clz diygwui diy-icon-moneybag"> </view>
						<view class="diygw-grid-title"> 收益提现 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid4-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid4-icon-clz diygwui diy-icon-new"> </view>
			...
			<view class="diygw-grid col-4">
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-clothes"> </view>
						<view class="diygw-grid-title"> 皮肤 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-cart"> </view>
						<view class="diygw-grid-title"> 订单 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-write"> </view>
						<view class="diygw-grid-title"> 反馈 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-moneybag"> </view>
						<view class="diygw-grid-title"> 钱包 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-comment"> </view>
						<view class="diygw-grid-title"> 评论 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-safe"> </view>
						<view class="diygw-grid-title"> 安全 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-profile"> </view>
						<view class="diygw-grid-title"> 隐私 </view>
					</view>
				</view>
				<view class="diygw-grid-item">
					<view class="diygw-grid-inner grid3-item-clz">
						<view class="diygw-grid-icon diygw-avatar radius grid3-icon-clz diygwui diy-icon-evaluate"> </view>
		...
		<view class="flex diygw-col-24">
			<view class="diygw-list">
				<view style="" class="diygw-item col-25 flex-direction-column list-item-clz">
					<view class="diygw-avatar list-icon-clz diygwui diy-icon-time"> </view>
					<view class="content">
				...
				<view style="" class="diygw-item col-25 flex-direction-column list-item-clz">
					<view class="diygw-avatar list-icon-clz diygwui diy-icon-medal"> </view>
					<view class="content">
				...
				<view style="" class="diygw-item col-25 flex-direction-column list-item-clz">
					<view class="diygw-avatar list-icon-clz diygwui diy-icon-selection"> </view>
					<view class="content">
				...
				<view style="" class="diygw-item col-25 flex-direction-column list-item-clz">
					<view class="diygw-avatar list-icon-clz diygwui diy-icon-coin">
