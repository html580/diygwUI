<view class="container">
	...
	<view class="flex diygw-col-24">
		<view class="diygw-grid diygw-actions">
			<button class="diygw-action">
				<view class="diygw-grid-inner">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-home">
			...
			<button class="diygw-action">
				<view class="diygw-grid-inner">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-settings"> </view>
					<view class="diygw-grid-title"> 菜单二 </view>
				</view>
			</button>
			<button class="diygw-action">
				<view class="diygw-grid-inner">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-subscription"> </view>
					<view class="diygw-grid-title"> 菜单三 </view>
				</view>
			</button>
			<button class="diygw-action">
				<view class="diygw-grid-inner">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-skin"> </view>
					<view class="diygw-grid-title"> 菜单四 </view>
				</view>
			</button>
		</view>
		...
		<view class="diygw-grid diygw-actions">
			<button class="diygw-action">
				<view class="diygw-grid-inner solid-right">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-home"> </view>
					<view class="diygw-grid-title"> 带边框 </view>
				</view>
			</button>
			<button class="diygw-action">
				<view class="diygw-grid-inner solid-right">
					<view class="diygw-grid-icon diygw-avatar diygwui diy-icon-settings">
						<view class="diygw-tag badge red"> 1 </view>
					</view>
					<view class="diygw-grid-title"> 菜单二 </view>
				</view>
