<view class="container">
	<view class="flex diygw-col-24 flex-wrap">
		<view class="diygw-avatar green margin-xs radius">
			<text class="diygwui diy-icon-shop"></text>
		</view>
		<view class="diygw-avatar red margin-xs radius">
			<text class="diygwui diy-icon-shopfill"></text>
		</view>
		...
		<view class="diygw-avatar yellow margin-xs radius">
			<text class="diygwui diy-icon-similar"></text>
		</view>
		<view class="diygw-avatar olive margin-xs radius">
			<text class="diygwui diy-icon-sound"></text>
		</view>
		...
		<view class="diygw-avatar brown margin-xs radius">
			<text class="diygwui diy-icon-subscription"></text>
		</view>
		<view class="diygw-avatar blue margin-xs radius">
			<text class="diygwui diy-icon-addressbook"></text>
		</view>
		<view class="diygw-avatar purple margin-xs radius">
			<text class="diygwui diy-icon-text"></text>
		</view>
		<view class="diygw-avatar red margin-xs radius">
			<text class="diygwui diy-icon-attentionfavor"></text>
		</view>
		<view class="diygw-avatar gradual-red margin-xs radius">
			<text class="diygwui diy-icon-time"></text>
		</view>
		<view class="diygw-avatar gradual-orange margin-xs radius">
			<text class="diygwui diy-icon-apps"></text>
		</view>
		<view class="diygw-avatar gradual-green margin-xs radius">
			<text class="diygwui diy-icon-unlock"></text>
		</view>
		<view class="diygw-avatar gradual-blue margin-xs radius">
			<text class="diygwui diy-icon-card"></text>
		</view>
		<view class="diygw-avatar gradual-orange margin-xs radius">
			<text class="diygwui diy-icon-backdelete"></text>
		</view>
		<view class="diygw-avatar gradual-blue margin-xs radius">
			<text class="diygwui diy-icon-baby"></text>
		</view>
		<view class="diygw-avatar gradual-purple margin-xs radius">
			<text class="diygwui diy-icon-barcode"></text>
		</view>
